...
public class PhotoAdapter extends ArrayAdapter<com.william.datingapp.Main.Cards> {
    Context mContext;


    public PhotoAdapter(@NonNull Context context, int resource, @NonNull List<com.william.datingapp.Main.Cards> objects) {
        super(context, resource, objects);
        this.mContext = context;
    }

    public View getView(final int position, View convertView, ViewGroup parent) {
        final com.william.datingapp.Main.Cards card_item = getItem(position);
